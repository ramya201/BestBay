...
FactoryGirl.define do
    ...
    factory :A7, parent: :item do
      name 'A7'
      description 'this is A2'
      price ''
      quantity '1'
      sale_type 'Auction'
      start_time '2012-11-30 00:00:00.0'
      end_time '2012-12-5 00:00:00.0'
      user_id '1'
      brand_id '1'
      category_id '1'
      subcategory_id '2'
    ...
    factory :A8, parent: :item do
      name 'A8'
      description 'this is A8'
      price ''
      quantity '0'
      sale_type 'Auction'
      start_time '2012-10-01 00:00:00.0'
      end_time '2012-10-15 00:00:00.0'
      user_id '1'
      brand_id '1'
      category_id '1'
      subcategory_id '2'
